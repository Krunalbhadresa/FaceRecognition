      ...
      <div className="measure">
        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
          ...
          <div className="mt3">
            ...
            <input className="pa2 br2 input-reset ba bg-transparent hover-white w-100" type="text" name="name" id="name"/>
          </div>
          <div className="mt3">
        ...
        <div className="lh-copy mt3">
          <p onClick={() => onRouteChange('signin')} className="f6 link hover-white pointer black db">Already registered?</p>
        </div>
      </div>
    </main>
  </article>
