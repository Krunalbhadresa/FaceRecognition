...
class Signin extends React.Component {
  ...
  render() {
    ...
    return (
      <article className="br2 ba dark-gray br3 shadow-5 mv6 w-100 w-50-m w-25-l mw7 center">
          ...
          <form className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mt3">
                ...
                <input 
                  className="pa2 br2 input-reset ba bg-transparent hover-white w-100" 
                  type="email" 
                  name="email-address"  
                  id="email-address"
              ...
              <div className="mv3">
                ...
                <input 
                  className="b pa2 br2 input-reset ba bg-transparent hover-white w-100" 
                  type="password" 
                  name="password"  
                  id="password"
